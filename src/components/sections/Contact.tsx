...
const Contact = () => {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      href: "https://maps.app.goo.gl/L3PxAvDYCdFjD9UG7",
    },
    {
      icon: Clock,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="rounded-2xl overflow-hidden h-40 bg-slate-100 relative">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3020.7231645707698!2d29.50820157574245!3d40.79009987138191!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cb23006c4dd687%3A0x66543f51199f4466!2sMeven%20Teknoloji!5e0!3m2!1str!2str!4v1774535615608!5m2!1str!2str"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
